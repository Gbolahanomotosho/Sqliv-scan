...
b="\033[1;34m"
w="\033[0m"
echo -e $b">"$w" \033[1;32mStarting sqliv scanning tool....."
sleep 0.5
...
pip3 install random
clear
echo -e $b">"$w" \033[0minstalling library: "$g"string"$w
...
clear
echo -e $b">"$w" \033[0minstalling library: "$g"json"$w
...
sleep 0.5
echo -e $b">"$w" \033[1;32mActivating sqliv scanner..... in:"
sleep 0.5
echo -e $b">"$w" 3"
sleep 0.3
echo -e $b">"$w" 2"
